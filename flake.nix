{
  ...
  outputs = {
    ...
    hyprlayer = craneLib.buildPackage (args
      // {
        CARGO_BUILD_RUSTFLAGS = "-C strip=symbols";
      });

    hyprlayer-musl-static = craneLib.buildPackage (args
      // {
  ...
  in
    flake-parts.lib.mkFlake {inherit inputs;} {
      ...
      perSystem = {
        ...
        apps = {inherit hyprlayer hyprlayer-musl-static;};
      in {
        ...
        packages = apps // {default = self.packages.${system}.hyprlayer;};
